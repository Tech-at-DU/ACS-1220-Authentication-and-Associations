...
| **2** | **Basic** | At least one of the auth routes (login or signup) is completed and functional. | Some routes have code that is messy and hard to follow. Some routes do not include docstrings. |
